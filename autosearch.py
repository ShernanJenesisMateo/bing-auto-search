...
try:
  ...
  # Add more places here
    ...
    for place in places_to_search:
        ...
        sleep_with_message("finding the search bar", 3)
        ...
        sleep_with_message("preparing to find the search bar again", 3)
        search_box = driver.find_element(By.ID, "sb_form_q")

        sleep_with_message("preparing to clear search bar", 3)
